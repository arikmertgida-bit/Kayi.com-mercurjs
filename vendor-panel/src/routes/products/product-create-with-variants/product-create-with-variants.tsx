...
export const ProductCreateWithVariants = () => {
    ...
    <RouteFocusModal>
      <RouteFocusModal.Title asChild>
        <span className="sr-only">
          {t("products.create.withVariants.title", "Varyasyonlu Ürün Oluştur")}
        </span>
      </RouteFocusModal.Title>
      <RouteFocusModal.Description asChild>
        <span className="sr-only">
          {t(
            "products.create.withVariants.description",
            "Varyasyonlu ürün bilgilerini girin"
          )}
        </span>
